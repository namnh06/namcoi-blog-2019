...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'revenue' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'revenue' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'revenue' ),
		'cyrillic'     => __( 'Cyrillic', 'revenue' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'revenue' ),
		'devanagari'   => __( 'Devanagari', 'revenue' ),
		'greek'        => __( 'Greek', 'revenue' ),
		'greek-ext'    => __( 'Greek Extended', 'revenue' ),
		'khmer'        => __( 'Khmer', 'revenue' ),
		'latin'        => __( 'Latin', 'revenue' ),
		'latin-ext'    => __( 'Latin Extended', 'revenue' ),
		'vietnamese'   => __( 'Vietnamese', 'revenue' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'revenue' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'revenue' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'revenue' ),
